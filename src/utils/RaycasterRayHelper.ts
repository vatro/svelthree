...
export class RaycasterRayHelper {
    ...
    constructor() {
        ...
        this.rayLineRGeom = new BufferGeometry().setFromPoints([new Vector3(0, 0, 0), new Vector3(0, 0, 0)])
        ...
        this.rayLineLGeom = new BufferGeometry().setFromPoints([new Vector3(0, 0, 0), new Vector3(0, 0, 0)])
        ...
        this.rayLineRGeom_pinch = new BufferGeometry().setFromPoints([new Vector3(0, 0, 0), new Vector3(0, 0, 0)])
        ...
        this.rayLineLGeom_pinch = new BufferGeometry().setFromPoints([new Vector3(0, 0, 0), new Vector3(0, 0, 0)])
    ...
    showPinchFw(
        ...
        if (handedness === "left") {
            ...
            this.rayLineLGeom_pinch = new BufferGeometry().setFromPoints([origin, checkPoint])
        ...
        if (handedness === "right") {
            ...
            this.rayLineRGeom_pinch = new BufferGeometry().setFromPoints([origin, checkPoint])
    ...
    showPinchRay(
        ...
        if (handedness === "left") {
            ...
            this.rayLineLGeom_pinch = new BufferGeometry().setFromPoints([rayData.origin, linePoint])
            ...
            if (pinchRayMaterial instanceof LineDashedMaterial) {
            }
            {
                this.rayLineL_pinch.computeLineDistances()
            }
        ...
        if (handedness === "right") {
            ...
            this.rayLineRGeom_pinch = new BufferGeometry().setFromPoints([rayData.origin, linePoint])
    ...
    show(
        ...
        if (handedness === "left") {
            ...
            this.rayLineLGeom = new BufferGeometry().setFromPoints([origin, checkPoint])
        ...
        if (handedness === "right") {
            ...
            this.rayLineRGeom = new BufferGeometry().setFromPoints([origin, checkPoint])
