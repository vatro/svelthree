...
<script lang="ts">
    ...
    */
	...
	$: controllerAvailable = $svelthreeStores[sti].xr.controller ? true : false
    ...
    */
	...
	function performVirtualHitTest(): void {
		...
		$svelthreeStores[sti].xr.controller.matrixWorld.decompose(originXR, quat, scale)

		directionXR.applyQuaternion(quat).normalize()
