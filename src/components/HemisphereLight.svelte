...
<script lang="ts">
	...
	// GENERATOR REMARK: 'reactive_re_creation_logic_1' not implemented for 'HemisphereLight'!
	...
	// GENERATOR REMARK: 'reactive_re_creation_logic_2' not implemented for 'HemisphereLight'!
