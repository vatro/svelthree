...
<script lang="typescript">
    ...
    import { Object3D, WebXRManager, WebGLRenderer, Group } from "svelthree-three"
    ...
    //e : {type, target}
    function dispatchVRGrippableInteractionEvent(e): void {
    ...
    //e : {type, target}
    function dispatchOnIntersect(e): void {
        const eventType: XrControllerEventType = e.type

        // TOFIX  uhm this is being logged 3x, why?!
        // TODO  delete this: Well because it's BEFORE the check youu stupid!
