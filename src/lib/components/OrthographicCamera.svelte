...
<script lang="ts">
	...
	export let camera: THREE_OrthographicCamera | undefined | null = undefined
	...
	export let aspect: boolean | undefined = undefined
   ...
   */
	export let frustumSize: number | undefined = undefined
	$: if (aspect === true) frustumSize = 1

	const defaultParams: ConstructorParameters<typeof THREE_OrthographicCamera> =
	 ...
	 */
	export let params: ConstructorParameters<typeof THREE_OrthographicCamera> | undefined = undefined

	$: if (!camera && create && store) {
		if (params) {
			camera = new THREE_OrthographicCamera(...params)
		} else {
			// we're using our own default parameters here (frustumSize)
			camera = new THREE_OrthographicCamera(...defaultParams)
		}
	...
	export let props: PropsOrthographicCamera | undefined = undefined
	...
	export let view: THREE_OrthographicCamera["view"] | undefined = undefined
	...
	export const get_instance = (): THREE_OrthographicCamera | undefined | null => camera
