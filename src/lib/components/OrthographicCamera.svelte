...
<script lang="ts">
	...
	export let camera: THREE_OrthographicCamera = undefined
   ...
   */
	 ...
	 */
	export let params: ConstructorParameters<typeof THREE_OrthographicCamera> = undefined
	...
	export let view: THREE_OrthographicCamera["view"] = undefined
