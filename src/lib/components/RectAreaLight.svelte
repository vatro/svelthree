...
<script lang="ts">
	...
	export let light: THREE_RectAreaLight = undefined
	...
	export let params: ConstructorParameters<typeof THREE_RectAreaLight> = undefined
	...
	export const get_instance = (): THREE_RectAreaLight => light
