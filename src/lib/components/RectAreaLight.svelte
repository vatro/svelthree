...
<script lang="ts">
	...
	import type { PropsRectAreaLight } from "../types/types-comp-props.js"
	...
	export let light: THREE_RectAreaLight | undefined | null = undefined
	...
	export let params: ConstructorParameters<typeof THREE_RectAreaLight> | undefined = undefined

	$: if (!light && create) {
		if (params) {
			light = new THREE_RectAreaLight(...params)
		} else {
			light = new THREE_RectAreaLight()
		}
	...
	export let props: PropsRectAreaLight | undefined = undefined
	...
	function set_height(): void {
		...
		if (light && height !== undefined) {
			...
			console.error(`SVELTHREE > ${c_name} > set_height : invalid 'light' instance and / or 'height' value!`, {
				light,
				height
			})
		}
	...
	function set_width(): void {
		...
		if (light && width !== undefined) {
			...
			console.error(`SVELTHREE > ${c_name} > set_width : invalid 'light' instance and / or 'width' value!`, {
				light,
				width
			})
		}
	...
	/**
	 * [See threejs-docs.](https://threejs.org/docs/#api/en/lights/RectAreaLight.power) */
	...
	export const get_helper = (): RectAreaLightHelper | undefined | null => {
		if (light) {
			return light.userData.helper as RectAreaLightHelper
		} else {
	...
	export const get_instance = (): THREE_RectAreaLight | undefined | null => light
