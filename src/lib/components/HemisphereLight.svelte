...
<script lang="ts">
	...
	export let light: THREE_HemisphereLight = undefined
	...
	export let params: ConstructorParameters<typeof THREE_HemisphereLight> = undefined
	...
	export const get_instance = (): THREE_HemisphereLight => light
