...
<script lang="ts">
	...
	import type { PropsHemisphereLight } from "../types/types-comp-props.js"
	...
	export let light: THREE_HemisphereLight | undefined | null = undefined
	...
	export let params: ConstructorParameters<typeof THREE_HemisphereLight> | undefined = undefined

	$: if (!light && create) {
		if (params) {
			light = new THREE_HemisphereLight(...params)
		} else {
			light = new THREE_HemisphereLight()
		}
	...
	export let props: PropsHemisphereLight | undefined = undefined
	...
	export const get_helper = (): HemisphereLightHelper | undefined | null => {
		if (light) {
	...
	export const get_instance = (): THREE_HemisphereLight | undefined | null => light
