...
<script lang="ts">
	...
	export let points: THREE_Points = undefined
	...
	export let params: ConstructorParameters<typeof THREE_Points> = undefined
	...
	$: if (!points && create) {
		if (geometry && material) {
			...
			points = new THREE_Points(geometry, material)
   ...
   */
	...
	export const get_instance = (): THREE_Points => points
