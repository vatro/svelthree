...
<script lang="ts">
	...
	import type { PropsPointLight, PropsPointLightShadow, PropsPerspectiveCamera } from "../types/types-comp-props.js"
	...
	export let light: THREE_PointLight | undefined | null = undefined
	...
	export let params: ConstructorParameters<typeof THREE_PointLight> | undefined = undefined
	...
	export let props: PropsPointLight | undefined = undefined
	...
	function set_rot() {
		...
		if (light && rot !== undefined) {
			PropUtils.setRotationFromValue(light, rot)
		} else {
			console.error(`SVELTHREE > ${c_name} > set_rot : invalid 'light' instance and / or 'rot' value!`, {
				light,
				rot
			})
		}
	...
	function set_quat() {
		...
		if (light && quat) {
			...
			console.error(`SVELTHREE > ${c_name} > set_quat : invalid 'light' instance and / or 'quat' value!`, {
				light,
				quat
			})
		}
	...
	function set_scale() {
		...
		if (light && scale !== undefined) {
			PropUtils.setScaleFromValue(light, scale)
		} else {
			console.error(`SVELTHREE > ${c_name} > set_scale : invalid 'light' instance and / or 'scale' value!`, {
				light,
				scale
			})
		}
	...
	export let shadowProps: PropsPointLightShadow | undefined = undefined
	...
	export const get_helper = (): PointLightHelper | undefined | null => {
		if (light) {
			return light.userData.helper as PointLightHelper
		} else {
	...
	export const get_instance = (): THREE_PointLight | undefined | null => light
