...
<script lang="ts">
	...
	export let light: THREE_AmbientLight | undefined | null = undefined
	...
	export let params: ConstructorParameters<typeof THREE_AmbientLight> | undefined = undefined
	...
	export let props: PropsAmbientLight | undefined = undefined
	...
	export const get_instance = (): THREE_AmbientLight | undefined | null => light
