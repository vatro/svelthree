...
There's an **impressive (_pretty new_) three.js component library for Svelte: [threlte](https://threlte.xyz/) / [grischaerbe/threlte](https://github.com/grischaerbe/threlte)** which is (_atm_) far more feature rich, complete and polished compared to `svelthree`. Also: **it's powered by Vercel + Rich Harris likes it a lot too!**
